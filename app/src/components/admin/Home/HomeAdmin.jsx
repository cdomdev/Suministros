          ...
          <section className="section-cards-home-admin">
            <Container>
              <div className="navbar-admin-section">
                <h2 className="text-menu-admin">Menu de adminitrador</h2>
              </div>
              <div className="container-cards-home-admin">
                ...
                <Link className="link-box" to="/admin/ver/tienda">
                  <div className="box-rutas-admin">
                    ...
                    <div className="text-primiry-box-rutas">
                      <p className="text-box-routes">Tienda</p>
                      <span className="span-box-rutas">Nevegar en tienda</span>
                    </div>
                  </div>
                </Link>
              </div>
