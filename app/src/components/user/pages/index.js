...
export {Lavaderos} from './Lavaderos'
...
export {Pedidos} from './PedidosPage'
export {FinnallyBuy} from './FinnallyBuy'
export {BañosCategoryPrimary} from './BañosCategoryPrimary'
export {CocinasCategoryPrimary} from './CocinasCategoryPrimary'
export {ConstruccionCategoryPrimary} from './ConstruccionCategoryPrimary'
export {PisosParedesCategoriPrimary} from './PisosParedesCategoriPrimary'