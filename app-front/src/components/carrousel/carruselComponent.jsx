    ...
    <div className="carrusel-container">
      <Carousel activeIndex={index} onSelect={handleSelect} className='carrusel'>
        <Carousel.Item className='carrusel-item'>
          <CarrruselImg imgUrl={img1} altText="First slide" className={'img-carrusel img-fluid' } fluid />
        ...
        <Carousel.Item className='carrusel-item'>
          <CarrruselImg imgUrl={img2} altText="Second slide" className={'img-carrusel img-fluid'} fluid />
          <Carousel.Caption className='caption'>
        ...
        <Carousel.Item className='carrusel-item'>
          <CarrruselImg imgUrl={img3} altText="Third slide" className={'img-carrusel img-fluid'} fluid />
          <Carousel.Caption className='caption'>
...
function CarrruselImg({imgUrl, altText, className}){
    return(
            <Image src={imgUrl} alt={altText} className={className} />
    )
}
