...
// import { encryptData as encryptDataUser} from "../utils/encryptionDataUsers";
  ...
  async function handleSuccess(credentialResponse) {
    if (credentialResponse.credential) {
      ...
      try {
        ...
        //   picture,
        // };
        // const { encryptData: encryptDataUser, iv } = await encryptDataUser(userDataProfile, "DTUFP"); // data user for profile
        // localStorage.setItem(
        //   "SesionEncripUser",
        //   JSON.stringify({ encryptData, iv })
        // );
