...
function enviarCorreo(cualNotificacion, nombre, email, pedido) {
  // Definir las notificaciones
  const notificaciones = [
    // compra
    // Notificacion para usuario
    {
      subject: `Compraste ${pedido}`,
      titulo: `¡Hola ${nombre}, tu compra fue realizada con exito` ,
      mensaje: `Este es el detale de tu pédido ${pedido}`,
    },
          ...
          <div class="container"
              ...
              <div style=" padding: 20px 10px;">
                  ...
                  <div
                      ...
                      <h4 style="font-weight: 500;">¡ Si tienes dudas sobre tu compra !</h4>
