...
const Register = () => {
  ...
  const handleSubmit = async (values) => {
    try {
      console.log('datos antes de la url'+ JSON.stringify(values));
      const URL = 'http://localhost:3000/registro';
      console.log('datos antes '+ JSON.stringify(values))
      const response = await axios.post(URL, values);
      console.log('despues de la solicitud'+ JSON.stringify(values));
